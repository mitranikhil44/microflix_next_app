...
(async () => {
        ...
        const articles = await page.$$eval(
          ...
          (elements, imageAttr) => {
            return elements.map((element) => {
              ...
              const image = imageElement ? (imageAttr == "data-src" ? "" : 'https:') + imageElement.getAttribute(imageAttr) : '';
  ...
  try {
    ...
    await Promise.all([
      ...
      scrapeModel(BASE_URLS.Bollywood, Bollywood, TOTAL_PAGES.Bollywood, 'data-src'),
